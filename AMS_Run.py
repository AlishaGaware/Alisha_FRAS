    ...
    try:
        ...
        if subb == '':
            ...
            def create_csv():
                import csv
                cursor.execute("select * from " + DB_table_name + ";")
                csv_name = r'C:\Users\Prachi\Desktop\Face-Recognition-Attendance-System-main\Attendance\Manually Attendance\\' + DB_table_name + '.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Users\Prachi\Desktop\Face-Recognition-Attendance-System-main\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = r'C:\Users\Prachi\Desktop\Face-Recognition-Attendance-System-main\AMS_Run.py' +fileName 
                with open(cs, mode="r", newline="") as file:
                    reader = csv.reader(file)
                    r = 0
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\Users\Prachi\Desktop\Face-Recognition-Attendance-System-main\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'pragya':
            if password == 'pragya123':
                ...
                cs = r'C:\Users\Prachi\Desktop\Face-Recognition-Attendance-System-main\StudentDetails\StudentDetails.csv'
